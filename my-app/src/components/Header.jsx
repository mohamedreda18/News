    ...
    <nav className="bg-white shadow-md sticky top-0 z-50 flex  px-4">
      <div className="container mx-auto">
        <div className=" px-4 p-[14px]">
            ...
            <div className=" flex space-x-10">
              {hideNave && (
                <nav className="space-x-6 hidden md:flex">
                  <Link
                    to="/business"
                    className="text-gray-800 hover:text-red-600 font-semibold transition duration-200 "
                  >
                    Business
                  </Link>
                  <Link
              ...
              <button
                className="hidden md:block hover:rotate-180 text-gray-800 hover:text-red-600 transition duration-200 cursor-pointer"
                onClick={() => {
                  setHideNave(!hideNave);
                }}
              >
          ...
          {menu && (
            <div className="absolute top-full left-0 pl-5 w-full bg-white/95 backdrop-blur-sm shadow-lg z-50 md:hidden">
              <div className=" py-4 border-t border-gray-200 ">
                <div className=" flex flex-col space-y-4">
                  <Link
                    to="/business"
                    className="text-gray-800 hover:text-red-600 focus:text-red-600 font-semibold transition duration-200   "
                    onClick={() => {
                      setIsMenuOpen(false);
                    }}
                  >
