            ...
            <div className='shadow-2xl'>
                ...
                <div className='p-5 space-y-2 '>
                    <div className='text flex flex-col '>
                        ...
                        <p className=''>The body of the late US Rep. John Lewis on Sunday will make the final journey across the famous bridge in Selma, Alabama, where he helped lead a march for voting rights in 1965.</p>
                    </div>
