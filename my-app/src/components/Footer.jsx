...
const Footer = () => {
    return (
        <footer className='bg-[#0E1E32]  h-48 relative  bottom-0 '>
            <div className='container mx-auto flex  justify-around items-center  h-full '>
                <div className='flex flex-col space-y-6 md:flex-row justify-around  py-10 items-center text-white  '>
                    <div className='flex flex-col items-center space-y-1'>
                        ...
                        <span>copyright &copy; 2020 | NBC NEWS</span>
                    </div>
                    <div className='w-1/3'>
                        <h2>
                            Privacy Policy
